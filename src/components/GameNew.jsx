...
const GameNew = () => {
    ...
    const apiKey = import.meta.env.VITE_APP_API_KEY_COUNTRIES;
            ...
            <div className="main-container">
                ...
                <div className="container">
                    <div className="wrapper">
                        <h2 className="title">
                            Countries Capital Temperature Game
                        </h2>
                        ...
                        <p className="rule">
                            🔰 <span>RULE :</span> If it's warmer, you get 100
                            points, otherwise the game is over!
                        </p>
                ...
                <div className="footer">
                    <p>
                        © All rights reserved by Mojtaba Mohseni | 📧
                        dev.mohseni@gmail.com
                    </p>
                </div>
            </div>
        </>
